...
int main()
{
    ...
    while (true)
    {
        ...
        // garantindo que o centro fique entre [square_width/2, WIDTH-square_width/2] e [square_height/2, HEIGHT-square_height/2].
        ...
        // (Opcional) Clamp, caso ainda queira garantir os limites:
        if (square_x < 0)
            square_x = 0;
        ...
        if (square_y < 0)
            square_y = 0;
        if (square_y > HEIGHT - square_height)
